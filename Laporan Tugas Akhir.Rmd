...
Aplikasi terdiri dari 6 tab yaitu :
1. Home
2. Unggah dan deskripsi data 
3. Visualisasi distribusi
4. Uji Formal Normalitas
5. Analisis Grouping
6. Kesimpulan Final 
Tab diisi Oleh fungsi fungsi yang sesuai dengan kebutuhan yang ada di server.
berikut library yang dipakai, dan helper function yang akan digunakan di server
...
1. Header dan Sidebar
Header merupakan judul di atas aplikasi, sementara Sidebar adalah menu navigasi yang terletak di samping kiri.
```{r}
ui <- dashboardPage(
...
2. DashboardBody
Dashboar Body merupakan isi dari setiap tab yang ada di dalam sidebar. Baris kode ini bertugas untuk menampilkan perhitungan/operasi yang ada di server baik dari visualisasi, uji formal, dan kesimpulan
```{r}
dashboardBody(
